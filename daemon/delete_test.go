...
func TestContainerDelete(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.doc, func(t *testing.T) {
			...
			err := d.ContainerRm(context.Background(), c.ID, &backend.ContainerRmConfig{ForceRemove: false})
...
func TestContainerDoubleDelete(t *testing.T) {
	...
	err := d.ContainerRm(context.Background(), c.ID, &backend.ContainerRmConfig{ForceRemove: true})
