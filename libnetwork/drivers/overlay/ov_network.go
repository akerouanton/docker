...
func (n *network) setupSubnetSandbox(s *subnet, brName, vxlanName string) error {
	...
	if err := sbox.AddInterface(context.Background(), brName, "br", osl.WithIPv4Address(s.gwIP), osl.WithIsBridge(true)); err != nil {
	...
	if err := sbox.AddInterface(context.Background(), vxlanName, "vxlan", osl.WithMaster(brName)); err != nil {
